...
with tf.device('/cpu:0'):
    ...
    case_config_file = os.environ['SV_ML_HOME']+'/dl_template/config/i2i3d_multiscale.yaml'

    print "getting app"

    from dl_template.experiments.NNapp_plugin import get_experiment
    App = get_experiment([global_config_file, case_config_file])
