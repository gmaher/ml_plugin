...
svMLSegmentationLegacySaveAction::svMLSegmentationLegacySaveAction()
{
}
...
void svMLSegmentationLegacySaveAction::Run(const QList<mitk::DataNode::Pointer> &selectedNodes)
{
...
void svMLSegmentationLegacySaveAction::SetDataStorage(mitk::DataStorage *dataStorage)
{
