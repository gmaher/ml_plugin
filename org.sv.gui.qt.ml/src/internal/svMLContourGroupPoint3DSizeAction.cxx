...
svMLContourGroupPoint3DSizeAction::svMLContourGroupPoint3DSizeAction()
...
void svMLContourGroupPoint3DSizeAction::Run(const QList<mitk::DataNode::Pointer> &selectedNodes)
{
...
void svMLContourGroupPoint3DSizeAction::SetDataStorage(mitk::DataStorage *dataStorage)
{
    m_DataStorage = dataStorage;
}

void svMLContourGroupPoint3DSizeAction::SetFunctionality(berry::QtViewPart *functionality)
{
