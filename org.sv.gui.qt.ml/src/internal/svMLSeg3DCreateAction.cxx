...
svMLSeg3DCreateAction::svMLSeg3DCreateAction()
...
void svMLSeg3DCreateAction::Run(const QList<mitk::DataNode::Pointer> &selectedNodes)
{
...
void svMLSeg3DCreateAction::SetDataStorage(mitk::DataStorage *dataStorage)
{
    m_DataStorage = dataStorage;
}

void svMLSeg3DCreateAction::SetFunctionality(berry::QtViewPart *functionality)
{
