...
#include "ui_svMLSeg2DEdit.h"
#include "ui_svMLLevelSet2DWidget.h"
#include "ui_svMLLoftParamWidget.h"
...
//    ui->resliceSlider->SetResliceMode(mitk::ExtractSliceFilter::RESLICE_LINEAR);
    ...
    m_LSParamWidget=new svMLLevelSet2DWidget(parent);
...
//    parent->setFixedWidth(400);
    ...
    m_LoftWidget=new svMLLoftParamWidget();
...
void svMLSeg2DEdit::Visible()
{
//    ui->resliceSlider->turnOnReslice(true);
    OnSelectionChanged(GetDataManagerSelection());
}

void svMLSeg2DEdit::Hidden()
{
    ui->resliceSlider->turnOnReslice(false);
    ClearAll();
}

//bool svMLSeg2DEdit::IsExclusiveFunctionality() const
//{
//    return true;
//}

int svMLSeg2DEdit::GetTimeStep()
{
...
void svMLSeg2DEdit::OnSelectionChanged(std::vector<mitk::DataNode*> nodes )
{
//    if(!IsActivated())
    if(!IsVisible())
    {
...
//    }
    ...
    //Add Observer
    itk::SimpleMemberCommand<svMLSeg2DEdit>::Pointer groupChangeCommand = itk::SimpleMemberCommand<svMLSeg2DEdit>::New();
    groupChangeCommand->SetCallbackFunction(this, &svMLSeg2DEdit::UpdateContourList);
    m_ContourGroupChangeObserverTag = m_ContourGroup->AddObserver( svContourGroupEvent(), groupChangeCommand);

    itk::SimpleMemberCommand<svMLSeg2DEdit>::Pointer loftCommand = itk::SimpleMemberCommand<svMLSeg2DEdit>::New();
    loftCommand->SetCallbackFunction(this, &svMLSeg2DEdit::LoftContourGroup);
    ...
    itk::SimpleMemberCommand<svMLSeg2DEdit>::Pointer flagOnCommand = itk::SimpleMemberCommand<svMLSeg2DEdit>::New();
    flagOnCommand->SetCallbackFunction(this, &svMLSeg2DEdit::ContourChangingOn);
    m_StartChangingContourObserverTag = m_ContourGroup->AddObserver( StartChangingContourEvent(), flagOnCommand);

    itk::SimpleMemberCommand<svMLSeg2DEdit>::Pointer flagOffCommand = itk::SimpleMemberCommand<svMLSeg2DEdit>::New();
    flagOffCommand->SetCallbackFunction(this, &svMLSeg2DEdit::ContourChangingOff);
    m_EndChangingContourObserverTag = m_ContourGroup->AddObserver( EndChangingContourEvent(), flagOffCommand);

    itk::SimpleMemberCommand<svMLSeg2DEdit>::Pointer selectCommand = itk::SimpleMemberCommand<svMLSeg2DEdit>::New();
    selectCommand->SetCallbackFunction(this, &svMLSeg2DEdit::SelectContour3D);
...
double svMLSeg2DEdit::GetVolumeImageSpacing()
{
...
void svMLSeg2DEdit::InsertContour(svContour* contour, int contourIndex)
{
...
void svMLSeg2DEdit::InsertContourByPathPosPoint(svContour* contour)
{
...
void svMLSeg2DEdit::SetContour(int contourIndex, svContour* newContour)
{
...
void svMLSeg2DEdit::RemoveContour(int contourIndex)
{
    if(m_ContourGroup&&contourIndex>-2)
    {
...
std::vector<int> svMLSeg2DEdit::GetBatchList()
{
...
svContour* svMLSeg2DEdit::PostprocessContour(svContour* contour)
{
...
void svMLSeg2DEdit::CreateContours(SegmentationMethod method)
{
    if(m_cvImage==NULL)
        return;
...
void svMLSeg2DEdit::SetSecondaryWidgetsVisible(bool visible)
{
...
void svMLSeg2DEdit::CreateThresholdContour()
{
    if(m_cvImage==NULL)
        return;
...
void svMLSeg2DEdit::UpdatePreview()
{
...
void svMLSeg2DEdit::FinishPreview()
{
    if(m_PreviewContourModel.IsNull())
         return;
...
void svMLSeg2DEdit::CreateEllipse()
{
...
void svMLSeg2DEdit::CreateCircle()
{
...
void svMLSeg2DEdit::CreateSplinePoly()
{
...
void svMLSeg2DEdit::CreatePolygon()
{
...
void svMLSeg2DEdit::SmoothSelected()
{
...
void svMLSeg2DEdit::DeleteSelected()
{
    QModelIndexList selectedRows=ui->listWidget->selectionModel()->selectedRows();
...
void svMLSeg2DEdit::SelectContour(int index)
{
    if(m_UpdatingGUI)
        return;
...
void svMLSeg2DEdit::SelectContour()
{
    if(m_UpdatingGUI)
        return;
...
void svMLSeg2DEdit::SelectContour(const QModelIndex & idx)
{
    int index=idx.row();
    SelectContour(index);
}

void svMLSeg2DEdit::NodeChanged(const mitk::DataNode* node)
{
}

void svMLSeg2DEdit::NodeAdded(const mitk::DataNode* node)
{
}

void svMLSeg2DEdit::NodeRemoved(const mitk::DataNode* node)
{
    OnSelectionChanged(GetDataManagerSelection());
}

void svMLSeg2DEdit::ClearAll()
{
    //Remove Observer
...
void svMLSeg2DEdit::UpdateContourList()
{
...
void svMLSeg2DEdit::LoftContourGroup()
{
...
void svMLSeg2DEdit::ShowLoftWidget()
{
...
void svMLSeg2DEdit::UpdateContourGroupLoftingParam()
{
    svLoftingParam *param=m_ContourGroup->GetLoftingParam();
    if(m_LoftWidget)
    {
...
void svMLSeg2DEdit::ApplyLofting()
{
    UpdateContourGroupLoftingParam();
    LoftContourGroup();
}

void svMLSeg2DEdit::HideLoftWidget()
{
    m_LoftWidget->hide();
}

void svMLSeg2DEdit::ContourChangingOn()
{
    m_ContourChanging=true;
}

void svMLSeg2DEdit::ContourChangingOff()
{
    m_ContourChanging=false;
//    if(m_CurrentSegButton)
//        m_CurrentSegButton->setStyleSheet("");
...
void svMLSeg2DEdit::UpdatePathResliceSize(double newSize)
{
    if(m_ContourGroup)
    {
...
void svMLSeg2DEdit::ManualContextMenuRequested()
{
    m_ManualMenu->popup(QCursor::pos());
}

void svMLSeg2DEdit::ManualCircleContextMenuRequested(const QPoint&)
{
    CreateManualCircle();
}

void svMLSeg2DEdit::ManualEllipseContextMenuRequested(const QPoint&)
{
    CreateManualEllipse();
}

void svMLSeg2DEdit::ManualSplinePolyContextMenuRequested(const QPoint&)
{
    CreateManualSplinePoly();
}

void svMLSeg2DEdit::ManualPolygonContextMenuRequested(const QPoint&)
{
    CreateManualPolygon();
}

void svMLSeg2DEdit::CreateManualCircle(bool)
{
    bool ok;
...
void svMLSeg2DEdit::CreateManualEllipse(bool)
{
    bool ok;
...
void svMLSeg2DEdit::CreateManualPolygonType(bool spline)
{
    bool ok;
...
void svMLSeg2DEdit::CreateManualSplinePoly(bool)
{
    CreateManualPolygonType(true);
}

void svMLSeg2DEdit::CreateManualPolygon(bool)
{
    CreateManualPolygonType(false);
}

void svMLSeg2DEdit::CopyContour()
{
    QModelIndexList selectedRows=ui->listWidget->selectionModel()->selectedRows();
...
void svMLSeg2DEdit::PasteContour()
{
...
void svMLSeg2DEdit::NewGroup()
{
    ...
    m_ContourGroupCreateWidget=new svMLContourGroupCreate(GetDataStorage(), m_ContourGroupNode,0);
    m_ContourGroupCreateWidget->show();
    m_ContourGroupCreateWidget->SetFocus();
}

void svMLSeg2DEdit::ShowPath(bool checked)
{
...
void svMLSeg2DEdit::PreparePreviewInteraction(QString method)
{
    ...
    itk::SimpleMemberCommand<svMLSeg2DEdit>::Pointer previewFinished = itk::SimpleMemberCommand<svMLSeg2DEdit>::New();
    previewFinished->SetCallbackFunction(this, &svMLSeg2DEdit::FinishPreview);
    m_PreviewContourModelObserverFinishTag = m_PreviewContourModel->AddObserver( EndInteractionContourModelEvent(), previewFinished);

    itk::SimpleMemberCommand<svMLSeg2DEdit>::Pointer previewUpdating = itk::SimpleMemberCommand<svMLSeg2DEdit>::New();
    previewUpdating->SetCallbackFunction(this, &svMLSeg2DEdit::UpdatePreview);
...
void svMLSeg2DEdit::UpdatePathPoint(int pos)
{
    if(m_PreviewDataNodeInteractor.IsNotNull())
        m_PreviewDataNodeInteractor->SetPathPoint(ui->resliceSlider->getCurrentPathPoint());
...
void svMLSeg2DEdit::QuitPreviewInteraction()
{
...
bool svMLSeg2DEdit::eventFilter(QObject *obj, QEvent *event)
{
    if (obj == ui->listWidget) {
        ...
        return svMLSeg2DEdit::eventFilter(obj, event);
    }
}


void svMLSeg2DEdit::SelectContour3D()
{
    if(m_DataInteractor.IsNotNull())
    {
