...
svMLLoftParamWidget::svMLLoftParamWidget(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::svMLLoftParamWidget)
{
    ui->setupUi(this);
...
svMLLoftParamWidget::~svMLLoftParamWidget()
{
    delete ui;
}

void svMLLoftParamWidget::UpdateGUI(svLoftingParam* param)
{
    if(param==NULL)
        return;
...
void svMLLoftParamWidget::UpdateParam(svLoftingParam* param)
{
    if(param==NULL)
        return;
...
void svMLLoftParamWidget::SelectionChanged(const QString &text)
{
    if(text=="nurbs")
...
void svMLLoftParamWidget::SetButtonGroupVisible(bool visible)
{
