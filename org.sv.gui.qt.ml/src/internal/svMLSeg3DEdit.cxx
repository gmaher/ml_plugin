...
const QString svMLSeg3DEdit::EXTENSION_ID = "org.sv.views.segmentation3d";

svMLSeg3DEdit::svMLSeg3DEdit() :
    ui(new Ui::svMLSeg3DEdit)
{
...
void svMLSeg3DEdit::CreateQtPartControl( QWidget *parent )
{
    m_Parent=parent;
    ui->setupUi(parent);
...
void svMLSeg3DEdit::Visible()
{
    OnSelectionChanged(GetDataManagerSelection());
}

void svMLSeg3DEdit::Hidden()
{
    ClearAll();
}

//bool svMLSeg3DEdit::IsExclusiveFunctionality() const
//{
//    return true;
//}

void svMLSeg3DEdit::OnSelectionChanged(std::vector<mitk::DataNode*> nodes )
{
//    if(!IsActivated())
    if(!IsVisible())
    {
...
void svMLSeg3DEdit::SetSeedVisibility(bool checked)
{
...
void svMLSeg3DEdit::CreateByCollidingFronts()
{
    if(!m_MitkSeg3D)
        return;
...
void svMLSeg3DEdit::NodeChanged(const mitk::DataNode* node)
{
}

void svMLSeg3DEdit::NodeAdded(const mitk::DataNode* node)
{
}

void svMLSeg3DEdit::NodeRemoved(const mitk::DataNode* node)
{
    OnSelectionChanged(GetDataManagerSelection());
}

void svMLSeg3DEdit::ClearAll()
{
    if(m_MitkSeg3DNode.IsNotNull())
    {
